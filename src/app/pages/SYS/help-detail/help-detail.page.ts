import { Component, ChangeDetectorRef, Input, ViewChild, Output, EventEmitter, ViewChildren, ElementRef, QueryList } from '@angular/core';
...
export class HelpDetailPage extends PageBase {
    ...
    loadQuillEditor() {
      if (typeof Quill !== 'undefined')  this.initQuill(); 
        ...
        const script = this.dynamicScriptLoaderService.loadScript('https://cdn.quilljs.com/1.3.6/quill.js')
        .then(() => {})
        .catch(error => console.error('Error loading script', error));
        
        const style = this.dynamicScriptLoaderService.loadStyle('https://cdn.quilljs.com/1.3.6/quill.snow.css')
        .then(() => {})
