...
export class IntegrationActionDetailPage extends PageBase {
	...
	preLoadData(event?: any): void {
		Promise.all([this.schemaProvider.read(), this.integrationProvider.read(), this.env.getType('IntegrationActionType')]).then((values: any) => {
	...
	loadedData(event?: any, ignoredFromGroup?: boolean): void {
		...
		if (this.item.IDProvider) {
			...
			Promise.all([this.actionAPIRunnerProvider.read(this.query), this.apiCollectionProvider.read(this.query)]).then((values: any) => {
