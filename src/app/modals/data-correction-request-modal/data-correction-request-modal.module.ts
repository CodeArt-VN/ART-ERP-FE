...
@NgModule({
  imports: [CommonModule, FormsModule, IonicModule, ReactiveFormsModule, PipesModule,TranslateModule,MapCompsModule,
    BusinessPartnerComponentsModule, ShareInputControlsModule ,RouterModule.forChild(routes)],
  declarations: [DataCorrectionRequestModalPage],
})
export class DataCorrectionRequestModalPageModule {}
