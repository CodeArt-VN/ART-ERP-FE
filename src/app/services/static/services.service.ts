...
export class CRM_BrandProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.CRM_Brand, SearchConfig.getSearchFields('CRM_Brand'), commonService);
	}
}
...
export class CRM_MembershipLoyaltyProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.CRM_MembershipLoyalty, SearchConfig.getSearchFields('CRM_MembershipLoyalty'), commonService);
	}
}
...
export class CRM_PolBenefitProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.CRM_PolBenefit, SearchConfig.getSearchFields('CRM_PolBenefit'), commonService);
	}
}
...
export class CRM_PolLevelBenefitProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.CRM_PolLevelBenefit, SearchConfig.getSearchFields('CRM_PolLevelBenefit'), commonService);
	}
}
...
export class CRM_RewardCategoryProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.CRM_RewardCategory, SearchConfig.getSearchFields('CRM_RewardCategory'), commonService);
	}
}
...
export class HRM_StaffPayrollConfigProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.HRM_StaffPayrollConfig, SearchConfig.getSearchFields('HRM_StaffPayrollConfig'), commonService);
	}
}
...
export class HRM_TimesheetTemplateProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.HRM_TimesheetTemplate, SearchConfig.getSearchFields('HRM_TimesheetTemplate'), commonService);
	}
}
...
export class HRM_WorkRuleGroupProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.HRM_WorkRuleGroup, SearchConfig.getSearchFields('HRM_WorkRuleGroup'), commonService);
	}
}
...
export class OSM_CategoryProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.OSM_Category, SearchConfig.getSearchFields('OSM_Category'), commonService);
	}
}
...
export class OSM_NotificationProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.OSM_Notification, SearchConfig.getSearchFields('OSM_Notification'), commonService);
	}
}
...
export class OSM_NotificationReceiverDeviceProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.OSM_NotificationReceiverDevice, SearchConfig.getSearchFields('OSM_NotificationReceiverDevice'), commonService);
	}
}
...
export class OSM_UserSubcriptionProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.OSM_UserSubcription, SearchConfig.getSearchFields('OSM_UserSubcription'), commonService);
	}
}
...
export class PURCHASE_ItemPlanningDataProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.PURCHASE_ItemPlanningData, SearchConfig.getSearchFields('PURCHASE_ItemPlanningData'), commonService);
	}
}
