...
@Injectable({ providedIn: 'root' })
export class HRM_PolWelfareDetailProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.HRM_PolWelfareDetail, SearchConfig.getSearchFields('HRM_PolWelfareDetail'), commonService);
	}
}

@Injectable({ providedIn: 'root' })
export class HRM_SalaryPolicyProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.HRM_SalaryPolicy, SearchConfig.getSearchFields('HRM_SalaryPolicy'), commonService);
	}
}
...
@Injectable({ providedIn: 'root' })
export class HRM_TaxPolicyProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.HRM_TaxPolicy, SearchConfig.getSearchFields('HRM_TaxPolicy'), commonService);
	}
}
...
@Injectable({ providedIn: 'root' })
export class SHIP_IndexProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.SHIP_Index, SearchConfig.getSearchFields('SHIP_Index'), commonService);
	}
}
