...
@Injectable({ providedIn: 'root' })
export class OST_JobDescriptionProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.OST_JobDescription, SearchConfig.getSearchFields('OST_JobDescription'), commonService);
	}
}

@Injectable({ providedIn: 'root' })
export class OST_JobRelationProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.OST_JobRelation, SearchConfig.getSearchFields('OST_JobRelation'), commonService);
	}
}
