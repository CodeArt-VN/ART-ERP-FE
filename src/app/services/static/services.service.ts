...
export class CRM_PolLevelGroupBrandProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.CRM_PolLevelGroupBrand, SearchConfig.getSearchFields('CRM_PolLevelGroupBrand'), commonService);
	}
}
...
export class POS_LogWorkOrderProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.POS_LogWorkOrder, SearchConfig.getSearchFields('POS_LogWorkOrder'), commonService);
	}
}
...
export class PROD_ItemReplacementGroupProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.PROD_ItemReplacementGroup, SearchConfig.getSearchFields('PROD_ItemReplacementGroup'), commonService);
	}
}
...
export class SYS_SyncJobIdentityReferenceProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.SYS_SyncJobIdentityReference, SearchConfig.getSearchFields('SYS_SyncJobIdentityReference'), commonService);
	}
}
...
@Injectable({ providedIn: 'root' })
export class VMS_PersonProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.VMS_Person, SearchConfig.getSearchFields('VMS_Person'), commonService);
	}
}


@Injectable({ providedIn: 'root' })
export class VMS_PersonFaceVectorProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.VMS_PersonFaceVector, SearchConfig.getSearchFields('VMS_PersonFaceVector'), commonService);
	}
}


@Injectable({ providedIn: 'root' })
export class VMS_PersonPhotoProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.VMS_PersonPhoto, SearchConfig.getSearchFields('VMS_PersonPhoto'), commonService);
	}
}


@Injectable({ providedIn: 'root' })
export class VMS_PersonVisitProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.VMS_PersonVisit, SearchConfig.getSearchFields('VMS_PersonVisit'), commonService);
	}
}
