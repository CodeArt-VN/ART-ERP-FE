...
export class DM_PR_ProgramItemProvider extends exService {
	constructor(public commonService: CommonService) {
		super(APIList.DM_PR_ProgramItem, SearchConfig.getSearchFields('DM_PR_ProgramItem'), commonService);
	}
}
