export var toolbarCommandRules = {
	...
	PURCHASE_Request: [
		...
		['Open', null, null, null, null, null, null, null, null, 'x', null, ' '],
	...
	PURCHASE_Quotation: [
		...
		['Draft', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x', null, 'x', null, null, ' '],
		...
		['Open', null, null, null, 'x', null, 'x', 'x', null, 'x', 'x', null, null, null, ' '],
		['Confirmed', null, null, null, 'x', null, 'x', 'x', null, 'x', null, 'x', null, null, ' '],
		['Submitted', null, null, null, null, 'x', 'x', null, null, null, null, null, null, null, ' '],
		['Unapproved', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x', null, 'x', null, null, ' '],
	...
	PURCHASE_Order: [
		...
		['Draft', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x', null, null, null, ' '],
		['Splitted', null, null, null, null, null, null, null, null, 'x', null, null, null, ' '],
		['Merged', null, null, null, null, null, null, null, null, 'x', null, null, null, ' '],
		['Canceled', null, null, null, null, null, null, null, 'x', 'x', null, null, null, ' '],
		['Unapproved', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x', null, null, null, ' '],
		['Submitted', null, null, null, null, 'x', 'x', null, null, null, null, null, null, ' '],
		['Approved', null, null, null, null, 'x', null, 'x', null, 'x', 'x', null, null, ' '],
		['Open', null, null, null, null, null, null, null, null, 'x', null, null, null, ' '],
		['Closed', null, null, null, null, null, null, null, null, 'x', null, null, null, ' '],
	...
	WMS_Receipt: [
		...
		['New', 'x', 'x', 'x', 'x', null, null, ' '],
		['Confirmed', null, 'x', 'x', 'x', 'x', null, ' '],
		['Scheduled', null, 'x', null, 'x', 'x', null, ' '],
		['Delivering', null, null, null, 'x', null, 'x', ' '],
		['Palletized', null, null, null, 'x', null, 'x', ' '],
		['Unloading', null, null, null, 'x', null, null, ' '],
	...
	BANK_OutgoingPayment: [
		...
		['NotSubmittedYet', 'x', 'x', 'x', null, null, 'x', 'x', 'x', 'x', null, ' '],
		['Canceled', null, null, null, null, null, null, null, 'x', null, null, ' '],
		['Unapproved', 'x', 'x', 'x', 'x', null, null, 'x', 'x', 'x', null, ' '],
		['Submitted', 'x', 'x', 'x', null, 'x', 'x', null, 'x', 'x', null, ' '],
	...
	SALE_Quotation: [
		...
		['Open', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x', ' '],
		['Splitted', null, null, null, null, null, null, null, null, 'x', ' '],
		['Merged', null, null, null, null, null, null, null, null, 'x', ' '],
		['Confirmed', null, null, null, null, null, null, null, null, null, ' '],
		['Submitted', null, null, null, null, 'x', 'x', null, null, null, ' '],
		['Unapproved', null, null, null, 'x', null, 'x', 'x', 'x', 'x', ' '],
		['Approved', null, null, null, null, 'x', null, 'x', null, null, 'x '],
		['Canceled', null, null, null, null, null, null, null, null, 'x', ' '],
	...
	SALE_Order: [
		...
		['Draft', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x', ' '],
		['New', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x', ' '],
		['Splitted', null, null, null, null, null, null, null, null, 'x', ' '],
		['Merged', null, null, null, null, null, null, null, null, 'x', ' '],
		['Canceled', null, null, null, null, null, null, null, 'x', 'x', ' '],
		['Submitted', null, null, null, null, 'x', 'x', null, null, null, ' '],
		...
		['Redelivery', null, null, null, null, null, null, null, null, 'x', ' '],
	...
	CRM_Contact: [
		...
		['Submitted', null, null, null, null, 'x', 'x', null, null, ' '],
		['Unapproved', 'x', 'x', 'x', 'x', null, 'x', 'x', 'x', 'x '],
