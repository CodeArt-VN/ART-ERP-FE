export var toolbarCommandRules = {
	...
	PURCHASE_Quotation: [
		{ Status: 'Draft', ShowBtns: ['ShowSplit', 'ShowMerge','ShowSendQuotaionRequest'] },
		{ Status: 'Open', ShowBtns: ['ShowSubmit', 'ShowApprove', 'ShowCancel', 'ShowDelete', 'ShowArchive'] },
		{ Status: 'Unapproved', ShowBtns: ['ShowSubmit', 'ShowApprove', 'ShowCancel', 'ShowDelete', 'ShowArchive','ShowSendQuotaionRequest'] },
		{ Status: 'Submitted', ShowBtns: ['ShowApprove', 'ShowDisapprove'] },
		{ Status: 'Approved', ShowBtns: ['ShowDisapprove', 'ShowCancel', 'ShowConfirm', 'ShowCopyToPriceListVersion', 'ShowCopyToPurchaseOrder'] },
		{ Status: 'Confirmed', ShowBtns: ['ShowSubmit', 'ShowApprove', 'ShowCancel', 'ShowReopenConfirmedQuotation','ShowSendQuotaionRequest'] },
