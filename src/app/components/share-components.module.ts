...
@NgModule({
	...
	exports: [
		ListToolbarComponent, DetailToolbarComponent, ModalDetailToolbarComponent, PageMessageComponent, QueryFilterComponent, ModalNotifyComponent, ShareDirectivesModule
	],
})
