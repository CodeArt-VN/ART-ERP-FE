...
export class ToolbarComponent implements OnInit {
  ...
  // private initShowButtons(){
  //   this.ShowAdd = this.page.pageConfig?.ShowAdd;
  //   this.ShowSearch = this.page.pageConfig?.ShowSearch;
  //   this.ShowRefresh = this.page.pageConfig?.ShowRefresh;
  //   this.ShowExport = this.page.pageConfig?.ShowExport;
  //   this.ShowImport = this.page.pageConfig?.ShowImport;
  //   this.ShowCopy = this.page.pageConfig?.ShowCopy;
  //   this.ShowChangeBranch = this.page.pageConfig?.ShowChangeBranch;
  //   this.ShowSubmit = this.page.pageConfig?.ShowSubmit;
  //   this.ShowApprove = this.page.pageConfig?.ShowApprove;
  //   this.ShowDisapprove = this.page.pageConfig?.ShowDisapprove;
  //   this.ShowMerge = this.page.pageConfig?.ShowMerge;
  //   this.ShowSplit = this.page.pageConfig?.ShowSplit;
  //   this.ShowCancel = this.page.pageConfig?.ShowCancel;
  //   this.ShowArchive = this.page.pageConfig?.ShowArchive;
  //   this.ShowDelete = this.page.pageConfig?.ShowDelete;
  //   this.ShowHelp = this.page.pageConfig?.ShowHelp;
  //   this.ShowFeature = this.page.pageConfig?.ShowFeature;
  // }
}
