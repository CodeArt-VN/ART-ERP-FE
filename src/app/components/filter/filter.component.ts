...
export class FilterComponent implements OnInit {
	...
	buildForm() {
		this.form = this.formBuilder.group({
			...
			Value: [this._item.Dimension !== 'logical' ? this._item.Value : null, this._item.Dimension !== 'logical' ? [Validators.required] : []],
	...
	onDrop(event: CdkDragDrop<FormArray>) {
		if (event.previousContainer === event.container) {
			...
			transferArrayItem(event.previousContainer.data.controls, event.container.data.controls, event.previousIndex, event.currentIndex);
		}
	}
