    ...
    loadPurchaseOrderNote() {
        ...
        this.loadingController.create({
            ...
            loading.present();
                    ...
                    var self = this
                    QRCode.toDataURL('PO:' + this.item.Id, { errorCorrectionLevel: 'H', version: 2, width: 500, scale: 20, type: 'image/webp' }, function (err, url) {
                        self.item.QRC = url;
                    })
                    ...
                    this.item.OrderLines.sort((a, b) => (parseFloat(a.ItemSort) - parseFloat(b.ItemSort)) || a._Item.Code.localeCompare(b._Item.Code));
